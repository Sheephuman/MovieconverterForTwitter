...
"wavpack"    // 可逆音声コーデック
            ...
            BitRateNumBox.PreviewKeyDown += queryBuidUpdown.NudTextBox_PreviewKeydon;
        ...
        private void QueryBuidButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                main._paramText.SelectAll();
                main._paramText.SelectedText = "";
                main._paramText.Text = PreviewBlock.Text;
            }
